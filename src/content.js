...
export const DEFAULT_CONTENT = {
  ...
  "about.team_body":
    "Roviq is not a solo build. Eric serves as Chief Technology Officer (CTO), owning technical architecture and build execution — apps, databases, and infrastructure across all five platform experiences and Roviq Core. Alex serves as Chief Financial Officer (FCO), bringing entrepreneurial and operating experience that complements the founder's product and technical background. This structure means Roviq is no longer a single-founder dependency for the product, technical, or financial side.",
